...
** Overfitting
   ...
   caused by a function that is too simple o uses too few features. At
   the other extreme, overfitting, or high variance, is caused by a
   ...
   angles unrelated to the data. This terminology is applied to both
